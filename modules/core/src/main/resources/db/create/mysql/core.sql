...
CREATE INDEX idx_sys_area_ts ON ${_prefix}sys_area (tree_sort ASC);
CREATE INDEX idx_sys_area_status ON ${_prefix}sys_area (status ASC);
CREATE INDEX idx_sys_area_pcs ON ${_prefix}sys_area (parent_codes ASC);
CREATE INDEX idx_sys_area_tss ON ${_prefix}sys_area (tree_sorts ASC);
CREATE INDEX idx_sys_company_cc ON ${_prefix}sys_company (corp_code ASC);
CREATE INDEX idx_sys_company_pc ON ${_prefix}sys_company (parent_code ASC);
CREATE INDEX idx_sys_company_ts ON ${_prefix}sys_company (tree_sort ASC);
CREATE INDEX idx_sys_company_status ON ${_prefix}sys_company (status ASC);
CREATE INDEX idx_sys_company_vc ON ${_prefix}sys_company (view_code ASC);
CREATE INDEX idx_sys_company_pcs ON ${_prefix}sys_company (parent_codes ASC);
CREATE INDEX idx_sys_company_tss ON ${_prefix}sys_company (tree_sorts ASC);
CREATE UNIQUE INDEX idx_sys_config_key ON ${_prefix}sys_config (config_key ASC);
CREATE INDEX idx_sys_dict_data_cc ON ${_prefix}sys_dict_data (corp_code ASC);
CREATE INDEX idx_sys_dict_data_dt ON ${_prefix}sys_dict_data (dict_type ASC);
CREATE INDEX idx_sys_dict_data_pc ON ${_prefix}sys_dict_data (parent_code ASC);
CREATE INDEX idx_sys_dict_data_status ON ${_prefix}sys_dict_data (status ASC);
CREATE INDEX idx_sys_dict_data_pcs ON ${_prefix}sys_dict_data (parent_codes ASC);
CREATE INDEX idx_sys_dict_data_ts ON ${_prefix}sys_dict_data (tree_sort ASC);
CREATE INDEX idx_sys_dict_data_tss ON ${_prefix}sys_dict_data (tree_sorts ASC);
CREATE INDEX idx_sys_dict_data_dv ON ${_prefix}sys_dict_data (dict_value ASC);
CREATE INDEX idx_sys_dict_type_is ON ${_prefix}sys_dict_type (is_sys ASC);
CREATE INDEX idx_sys_dict_type_status ON ${_prefix}sys_dict_type (status ASC);
CREATE INDEX idx_sys_employee_cco ON ${_prefix}sys_employee (company_code ASC);
CREATE INDEX idx_sys_employee_cc ON ${_prefix}sys_employee (corp_code ASC);
CREATE INDEX idx_sys_employee_ud ON ${_prefix}sys_employee (update_date ASC);
CREATE INDEX idx_sys_employee_oc ON ${_prefix}sys_employee (office_code ASC);
CREATE INDEX idx_sys_employee_status ON ${_prefix}sys_employee (status ASC);
CREATE INDEX idx_sys_file_entity_md5 ON ${_prefix}sys_file_entity (file_md5 ASC);
CREATE INDEX idx_sys_file_entity_size ON ${_prefix}sys_file_entity (file_size ASC);
CREATE INDEX idx_sys_file_biz_ft ON ${_prefix}sys_file_upload (file_type ASC);
CREATE INDEX idx_sys_file_biz_fi ON ${_prefix}sys_file_upload (file_id ASC);
CREATE INDEX idx_sys_file_biz_status ON ${_prefix}sys_file_upload (status ASC);
CREATE INDEX idx_sys_file_biz_cb ON ${_prefix}sys_file_upload (create_by ASC);
CREATE INDEX idx_sys_file_biz_ud ON ${_prefix}sys_file_upload (update_date ASC);
CREATE INDEX idx_sys_file_biz_bt ON ${_prefix}sys_file_upload (biz_type ASC);
CREATE INDEX idx_sys_file_biz_bk ON ${_prefix}sys_file_upload (biz_key ASC);
CREATE INDEX idx_sys_job_status ON ${_prefix}sys_job (status ASC);
CREATE INDEX idx_sys_job_log_jn ON ${_prefix}sys_job_log (job_name ASC);
CREATE INDEX idx_sys_job_log_jg ON ${_prefix}sys_job_log (job_group ASC);
CREATE INDEX idx_sys_job_log_t ON ${_prefix}sys_job_log (job_type ASC);
CREATE INDEX idx_sys_job_log_e ON ${_prefix}sys_job_log (job_event ASC);
CREATE INDEX idx_sys_job_log_ie ON ${_prefix}sys_job_log (is_exception ASC);
CREATE INDEX idx_sys_lang_code ON ${_prefix}sys_lang (lang_code ASC);
CREATE INDEX idx_sys_lang_type ON ${_prefix}sys_lang (lang_type ASC);
CREATE INDEX idx_sys_log_cb ON ${_prefix}sys_log (create_by ASC);
CREATE INDEX idx_sys_log_cc ON ${_prefix}sys_log (corp_code ASC);
CREATE INDEX idx_sys_log_lt ON ${_prefix}sys_log (log_type ASC);
CREATE INDEX idx_sys_log_bk ON ${_prefix}sys_log (biz_key ASC);
CREATE INDEX idx_sys_log_bt ON ${_prefix}sys_log (biz_type ASC);
CREATE INDEX idx_sys_log_ie ON ${_prefix}sys_log (is_exception ASC);
CREATE INDEX idx_sys_log_cd ON ${_prefix}sys_log (create_date ASC);
CREATE INDEX idx_sys_menu_pc ON ${_prefix}sys_menu (parent_code ASC);
CREATE INDEX idx_sys_menu_ts ON ${_prefix}sys_menu (tree_sort ASC);
CREATE INDEX idx_sys_menu_status ON ${_prefix}sys_menu (status ASC);
CREATE INDEX idx_sys_menu_mt ON ${_prefix}sys_menu (menu_type ASC);
CREATE INDEX idx_sys_menu_pss ON ${_prefix}sys_menu (parent_codes ASC);
CREATE INDEX idx_sys_menu_tss ON ${_prefix}sys_menu (tree_sorts ASC);
CREATE INDEX idx_sys_menu_sc ON ${_prefix}sys_menu (sys_code ASC);
...
CREATE INDEX idx_sys_msg_inner_cl ON ${_prefix}sys_msg_inner (content_level ASC);
CREATE INDEX idx_sys_msg_inner_sc ON ${_prefix}sys_msg_inner (send_user_code ASC);
CREATE INDEX idx_sys_msg_inner_sd ON ${_prefix}sys_msg_inner (send_date ASC);
CREATE INDEX idx_sys_msg_inner_r_mi ON ${_prefix}sys_msg_inner_record (msg_inner_id ASC);
CREATE INDEX idx_sys_msg_inner_r_ruc ON ${_prefix}sys_msg_inner_record (receive_user_code ASC);
CREATE INDEX idx_sys_msg_inner_r_stat ON ${_prefix}sys_msg_inner_record (read_status ASC);
CREATE INDEX idx_sys_msg_inner_r_star ON ${_prefix}sys_msg_inner_record (is_star ASC);
CREATE INDEX idx_sys_msg_push_type ON ${_prefix}sys_msg_push (msg_type ASC);
CREATE INDEX idx_sys_msg_push_rc ON ${_prefix}sys_msg_push (receive_code ASC);
CREATE INDEX idx_sys_msg_push_uc ON ${_prefix}sys_msg_push (receive_user_code ASC);
CREATE INDEX idx_sys_msg_push_suc ON ${_prefix}sys_msg_push (send_user_code ASC);
CREATE INDEX idx_sys_msg_push_pd ON ${_prefix}sys_msg_push (plan_push_date ASC);
CREATE INDEX idx_sys_msg_push_ps ON ${_prefix}sys_msg_push (push_status ASC);
CREATE INDEX idx_sys_msg_push_rs ON ${_prefix}sys_msg_push (read_status ASC);
CREATE INDEX idx_sys_msg_push_bk ON ${_prefix}sys_msg_push (biz_key ASC);
CREATE INDEX idx_sys_msg_push_bt ON ${_prefix}sys_msg_push (biz_type ASC);
CREATE INDEX idx_sys_msg_push_imp ON ${_prefix}sys_msg_push (is_merge_push ASC);
CREATE INDEX idx_sys_msg_pushed_type ON ${_prefix}sys_msg_pushed (msg_type ASC);
CREATE INDEX idx_sys_msg_pushed_rc ON ${_prefix}sys_msg_pushed (receive_code ASC);
CREATE INDEX idx_sys_msg_pushed_uc ON ${_prefix}sys_msg_pushed (receive_user_code ASC);
CREATE INDEX idx_sys_msg_pushed_suc ON ${_prefix}sys_msg_pushed (send_user_code ASC);
CREATE INDEX idx_sys_msg_pushed_pd ON ${_prefix}sys_msg_pushed (plan_push_date ASC);
CREATE INDEX idx_sys_msg_pushed_ps ON ${_prefix}sys_msg_pushed (push_status ASC);
CREATE INDEX idx_sys_msg_pushed_rs ON ${_prefix}sys_msg_pushed (read_status ASC);
CREATE INDEX idx_sys_msg_pushed_bk ON ${_prefix}sys_msg_pushed (biz_key ASC);
CREATE INDEX idx_sys_msg_pushed_bt ON ${_prefix}sys_msg_pushed (biz_type ASC);
CREATE INDEX idx_sys_msg_pushed_imp ON ${_prefix}sys_msg_pushed (is_merge_push ASC);
CREATE INDEX idx_sys_msg_tpl_key ON ${_prefix}sys_msg_template (tpl_key ASC);
CREATE INDEX idx_sys_msg_tpl_type ON ${_prefix}sys_msg_template (tpl_type ASC);
CREATE INDEX idx_sys_msg_tpl_status ON ${_prefix}sys_msg_template (status ASC);
CREATE INDEX idx_sys_office_cc ON ${_prefix}sys_office (corp_code ASC);
CREATE INDEX idx_sys_office_pc ON ${_prefix}sys_office (parent_code ASC);
CREATE INDEX idx_sys_office_pcs ON ${_prefix}sys_office (parent_codes ASC);
CREATE INDEX idx_sys_office_status ON ${_prefix}sys_office (status ASC);
CREATE INDEX idx_sys_office_ot ON ${_prefix}sys_office (office_type ASC);
CREATE INDEX idx_sys_office_vc ON ${_prefix}sys_office (view_code ASC);
CREATE INDEX idx_sys_office_ts ON ${_prefix}sys_office (tree_sort ASC);
CREATE INDEX idx_sys_office_tss ON ${_prefix}sys_office (tree_sorts ASC);
CREATE INDEX idx_sys_post_cc ON ${_prefix}sys_post (corp_code ASC);
CREATE INDEX idx_sys_post_status ON ${_prefix}sys_post (status ASC);
CREATE INDEX idx_sys_post_ps ON ${_prefix}sys_post (post_sort ASC);
CREATE INDEX idx_sys_role_cc ON ${_prefix}sys_role (corp_code ASC);
...
CREATE INDEX idx_sys_user_wo ON ${_prefix}sys_user (wx_openid ASC);
CREATE INDEX idx_sys_user_imei ON ${_prefix}sys_user (mobile_imei ASC);
CREATE INDEX idx_sys_user_rt ON ${_prefix}sys_user (user_type ASC);
CREATE INDEX idx_sys_user_rc ON ${_prefix}sys_user (ref_code ASC);
CREATE INDEX idx_sys_user_mt ON ${_prefix}sys_user (mgr_type ASC);
CREATE INDEX idx_sys_user_us ON ${_prefix}sys_user (user_weight ASC);
CREATE INDEX idx_sys_user_ud ON ${_prefix}sys_user (update_date ASC);
CREATE INDEX idx_sys_user_status ON ${_prefix}sys_user (status ASC);
CREATE INDEX idx_sys_user_cc ON ${_prefix}sys_user (corp_code ASC);
